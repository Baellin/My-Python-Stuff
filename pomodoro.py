...
class PomodoroTimer:
    ...
    def __init__(self): # UI code
        ...
        self.s = ttk.Style()
        self.s.configure("TNotebook.Tab", font=("Times News Roman", 16))
        self.s.configure("TButton", font=("Times News Roman", 16))

        self.tabs = ttk.Notebook(self.root)
        self.tabs.pack(fill="both", pady=10, expand=True)

        self.tab1 = tk.Frame(self.tabs, width=600, height=100)
        self.tab2 = tk.Frame(self.tabs, width=600, height=100)
        self.tab3 = tk.Frame(self.tabs, width=600, height=100)

        self.pomodoro_timer_label = ttk.Label(self.tab1, text="25:00", font=("Times News Roman", 48))
        self.pomodoro_timer_label.pack(pady=20)

        self.short_break_timer_label = ttk.Label(self.tab2, text="05:00", font=("Times News Roman", 48))
        self.short_break_timer_label.pack(pady=20)

        self.long_break_timer_label = ttk.Label(self.tab3, text="15:00", font=("Times News Roman", 48))
